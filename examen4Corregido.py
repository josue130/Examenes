...
print("Apartado~~>mostrar_info")
p1=canchas("Josue",62925579,"Siquirres","josue@gmail.com")
p1.mostrarInfo()
print("                                                   ")
print("                                                   ")

print("<------------------------------------------------------>")
print("Apartado~~>crear_cancha")
p1.crear_cancha(100)
print("                                                   ")
print("                                                   ")
print("<--------------------------------------------------->")
print("Apartado~~>crear_cliente")
p1.crear_cliente(702950042,"Josue",62925579,"Josue@gmail.com")
p1.mostrarCliente(702950042)
print("                                                   ")
print("                                                   ")
print("<--------------------------------------------------->")
print("Apartado~~>mostrar_cliente")
p1.mostrarCliente(702950042)

print("                                                   ")
print("                                                   ")
print("<----------------------------------------------------->")
print("Apartado~~>modificar_cliente")
p1.modificar_cliente(702950042,62925578,"lopez@gmail.com")
p1.mostrarCliente(702950042)
print("                                                   ")
print("                                                   ")
...
print("<----------------------------------------------------->")
print("Apartado~~>reservar_cancha")

p1.reservar_cancha(702950042,101,"2021",1,4)
p1.reservar_cancha(702950042,101,"2021",4,5)
p1.mostrar_reserva(1)
p1.mostrar_reserva(2)
print("                                                   ")
print("                                                   ")
print("<----------------------------------------------------------->")
print("Apartado~~>modificar_reserva")
print("Se modificara la reserva 1")
p1.modificar_reserva(1,"2021",5,6)
p1.mostrar_reserva(1)
print("                                                   ")
print("                                                   ")
print("<----------------------------------------------------------->")
print("Apartado~~>quitar_reserva")
print("Se quito la reserva 1")
p1.quitar_reserva(1)
print("<----------------------------------------------------------->")
print("Apartado~~>mostrar_reserva")
p1.mostrar_reserva(2)
print("                                                   ")
print("                                                   ")
print("<----------------------------------------------------------->")
print("Apartado~~>ver_reservas")
p1.ver_reservas("2021")
print("                                                   ")
print("                                                   ")
print("<----------------------------------------------------------->")
print("Apartado~~>facturar")
p1.facturar(2)
print("                                                   ")
print("                                                   ")
print("<----------------------------------------------------------->")
print("Apartado~~>mostrar_facturas")
p1.ver_fecturas("2021")
